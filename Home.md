...
* [Batch Connection API for Faster Mulitple Connection Requests](https://github.com/CassiaNetworks/CassiaSDKGuide/wiki/RESTful-API#batch-connect-to-a-target-device-v20-and-above) (v2.0 and above)
---
